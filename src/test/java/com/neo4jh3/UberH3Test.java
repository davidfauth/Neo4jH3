...
//assertEquals("39.678106484915,-120.23540752726865",result.single().get("value").asString());
        ...
        result = session.run("call com.neo4jh3.coverage(['-122.481889,37.826683','122.479487,37.808548','-122.481889,37.826683','-122.479487,37.808548','-122.474150,37.808904','-122.476510,37.826935','-122.481889,37.826683'],8,'lonlat') yield value return value limit 1");
        assertEquals(613196571542028287L,result.single().get(0).asLong());

        result = session.run("call com.neo4jh3.coverage(['-122.481889,37.826683','122.479487,37.808548','-122.481889,37.826683','-122.479487,37.808548','-122.474150,37.808904','-122.476510,37.826935','-122.481889,37.826683'],17,'lonlat') yield value return value limit 1");
        assertEquals(-2L,result.single().get(0).asLong());

        result = session.run("call com.neo4jh3.coverageString(['-122.481889,37.826683','122.479487,37.808548','-122.481889,37.826683','-122.479487,37.808548','-122.474150,37.808904','-122.476510,37.826935','-122.481889,37.826683'],8,'lonlat') yield value return value limit 1");
        assertEquals("\"8828308703fffff\"",result.single().get(0).toString()); 

        result = session.run("call com.neo4jh3.coverageString(['-122.481889,37.826683','122.479487,37.808548','-122.481889,37.826683','-122.479487,37.808548','-122.474150,37.808904','-122.476510,37.826935','-122.481889,37.826683'],17,'lonlat') yield value return value limit 1");
